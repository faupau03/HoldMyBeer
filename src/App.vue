<template>
  <div class="grid justify-center items-center h-screen relative">
      ...
      <div class="display">
        <div class="artboard artboard-demo phone-1 relative"> -->
          <!-- wrapper -->
            ...
            <!-- Bottom navigation -->
            <div v-show="route.path.includes('app')" class="btm-nav fixed" >
              <router-link to="/app/" class="text-primary" :class="{'active': (route.path == ('/app') || route.path == ('/app/'))}">
              ...
              <router-link to="/app/friends" class="text-primary" :class="{'active': route.path.includes('friends')}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <router-link to="/app/bar" class="text-primary" :class="{'active': route.path.includes('bar')}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
